...
class Dealer {
	...
	/*
	 * Gives the dealer another card and updates the value of his hand. Takes
	 * into account the value of aces.
	 */
	...
	/*
	 * Determines if the dealer wants to hit according to classic Blackjack
	 * rules.
	 */
